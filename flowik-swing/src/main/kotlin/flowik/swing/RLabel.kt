...
class RLabel : JLabel(), RComponent {
    ...
    fun bindText(comp: Computed<String>) {
    ...
    companion object {
        ...
        fun of(comp: Computed<String>): RLabel = RLabel().also { it.bindText(comp) }
...
fun PanelScope.Label(comp: Computed<String>): RLabel = RLabel.of(comp).also { panel.add(it) }
